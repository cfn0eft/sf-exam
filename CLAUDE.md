...
- 対応資格（全8資格 LP 公開済）: Administrator (合格済・437問) / Platform App Builder (445問) / Developer (499問) / Agentforce Specialist (138問) / Sales Cloud コンサル (200問) / Service Cloud コンサル (123問) / Experience Cloud コンサル (131問) / Sharing & Visibility アーキテクト (88問)
