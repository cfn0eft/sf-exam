...
Agentforceは2026-09-14に182問へ更新しました。先の2問追加・8問修正に続き、優先ソースの論点から6問を追加し、既存19問を公式資料で見直しました。スナップショット、項目生成、有害性の確信度、本人確認と顧客単位のアクセス制御、Flowデータの受け渡しなどを修正し、重複4組は異なる判断を問う形に整理しています。[101問の照合記録](docs/agentforce-jpn101-source-intake-2026-09-14.json)と[106問版の照合記録](docs/agentforce-jpn106-source-intake-2026-09-14.json)に既存対応・関連・保留・未追加を区別しました。全件の正誤監査と分野バランスの補正は未完了です。
