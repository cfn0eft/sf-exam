...
| **Salesforce 認定 Agentforce Specialist** | AI-201 | **189 問** | 6 分野 | 26 語 | — | 72% |
...
Agentforceは2026-09-26に189問へ更新しました。Jpnshikenの最新154問版から、未処理セッションの即時トレース、サブエージェント誤ルーティング、エージェントユーザーのオブジェクト権限、分類説明とスコープ、Record Snapshotの空データ除外、アクション指示の発話例、Trust Layerのマスキング設定境界を7問追加し、ブランド固有の評価をLLM Judgeによるカスタム評価へ修正しました。取得した41問のうち、既存問題との重複、公式仕様と異なる正答、模擬出典、保留を区別しています。[154問版の照合記録](docs/agentforce-jpn154-source-intake-2026-09-26.json)、[101問の照合記録](docs/agentforce-jpn101-source-intake-2026-09-14.json)、[106問版の照合記録](docs/agentforce-jpn106-source-intake-2026-09-14.json)を参照してください。残り113問の本文取得と正誤監査は未完了です。
